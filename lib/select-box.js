...
module.exports = React.createClass({displayName: 'exports',
  ...
  changeOnClose: function () {
    return String(this.props.changeOnClose) === 'true'
  },

  updatePendingValue: function (value) {
    if (this.changeOnClose()) {
      this.setState({pendingValue: value || this.props.value})
      return true
    }
    return false
  },
  ...
  handleChange: function (val) {
    return function (event) {
      ...
      if (this.isMultiple()) {
        ...
        this.updatePendingValue(selected) || this.props.onChange(selected)
      } else {
        this.updatePendingValue(val) || this.props.onChange(val)
