...
module.exports = React.createClass({
  ...
  getDefaultProps: function () {
    return {
      idPrefix: 'react-select-box-' + optionKeyIndex++
    }
  },
  ...
  handleOptionFocus: function (event) {
    this.handleFocus(event)
    var children = this.refs.options.getDOMNode().childNodes
    console.log(children)
    console.log(event.target)
    var index = [].indexOf.call(children, event.target)
    console.log(index)
    this.setState({ focusedIndex: index }, this.focusOption)
  },

  focusOption: function () {
    this.refs.options.getDOMNode().childNodes[this.state.focusedIndex].focus()
  },
